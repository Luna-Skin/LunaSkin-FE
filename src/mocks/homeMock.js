...
export const MOCK_SKIN_RECORDS = {
  "2026-07-30": {
    ...
    compareInsight: // "피부 기록 비교" 화면의 "AI 분석" 박스에 들어가는, 직전 기록 대비 코멘트
      "가장 이른 기록이라 비교할 직전 기록이 없어요.",
  ...
  "2026-08-01": {
    ...
    compareInsight:
      "직전 기록보다 트러블과 칙칙함이 줄고 수분·탄력이 함께 올라갔어요. 지금 루틴이 잘 맞고 있는 것 같으니 이대로 유지해보세요.",
  ...
  "2026-08-03": {
    ...
    compareInsight:
      "직전 기록과 비슷하거나 소폭 개선된 수준이에요. 배란기 특유의 안정적인 밸런스가 계속 유지되고 있어요.",
  ...
  "2026-08-06": {
    ...
    compareInsight:
      "직전 기록보다 유분·트러블·칙칙함이 늘고 수분은 크게 줄었어요. 황체기로 접어들며 피지 분비가 늘어난 영향으로 보여요. 저자극 클렌저로 가볍게 세안하고 수분 크림으로 장벽을 보강해보세요.",
